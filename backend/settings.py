...
DEBUG = 'YES' == os.getenv('DEBUG_MODE')  # With value False, Django administration doesn't work
ENABLE_CORS_FILTER = 'YES' == os.getenv('ENABLE_CORS_FILTER')
PRO_DATABASE = 'YES' == os.getenv('PRO_DATABASE')
